    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          textFieldBody(context, pic, user, friend, forStatus)
          ,
        ],
      ),
    );
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          suffixIcon: sendIconBody(context, pic, user, friend, forStatus),
      ...
      onPressed: () async {
        if (forStatus) {
          ...
          await Provider.of<ImagingProvider>(context, listen: false)
              .addImageMessage(pic, user.id, friend!.id, controller.text);
        }
